...
T.ScrollBar {
    ...
    property color color : SekTheme.dark ? Qt.rgba(159/255,159/255,159/255,1) : Qt.rgba(138/255,138/255,138/255,1)
    property color pressedColor: SekTheme.dark ? Qt.darker(color,1.2) : Qt.lighter(color,1.2)
    ...
    background: Rectangle{
        id:back_rect
        radius: 5
        color:SekTheme.dark ? Qt.rgba(44/255,44/255,44/255,1) : Qt.rgba(255/255,255/255,255/255,1)
        opacity:{
            if(vertical){
    ...
    SekIconButton{
        ...
        iconSource: SekentIcons.CaretLeftSolid8
        onClicked: {
            control.decrease()
        }
    }
    SekIconButton{
        ...
        visible: control.horizontal
        iconSource: SekentIcons.CaretRightSolid8
        onClicked: {
            control.increase()
        }
    }
    SekIconButton{
        ...
        iconSource: SekentIcons.CaretUpSolid8
        onClicked: {
            control.decrease()
        }
    }
    SekIconButton{
        ...
        visible: control.vertical
        iconSource: SekentIcons.CaretDownSolid8
        onClicked: {
            control.increase()
        }
    }
