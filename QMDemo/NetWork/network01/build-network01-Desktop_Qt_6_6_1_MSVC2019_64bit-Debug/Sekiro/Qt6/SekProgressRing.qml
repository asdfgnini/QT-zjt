...
ProgressBar{
    ...
    property color color: SekTheme.primaryColor
    property color backgroundColor : SekTheme.dark ? Qt.rgba(99/255,99/255,99/255,1) : Qt.rgba(214/255,214/255,214/255,1)
    id:control
    indeterminate : true
    clip: true
